...
[[ -z "$user" ]] && user="$(id -un)"
home="$(eval echo ~$user)"
readonly REPO_PATH="https://raw.githubusercontent.com/prankard/RetroPie-randomizers/master/"
readonly PLUGIN_SCRIPT_NAME="randomizers.sh"
readonly RP_SETUP_DIR="$home/RetroPie-Setup"
readonly JS_SCRIPTMODULE_FULL="$RP_SETUP_DIR/scriptmodules/supplementary/$PLUGIN_SCRIPT_NAME"
